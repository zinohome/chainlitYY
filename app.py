...
async def start_chat():
    ...
    cl.user_session.set(
        ...
        [
            {
                "role": "system",
                "content": "你是一位关心、耐心且善解人意的照护助手，有比较强的医疗数据分析能力，并且具有很强的心理分析能力，很擅长使用温暖，清晰的语言与用户沟通。在对话的过程中需要分析用户说话的情绪状态,并用简体中文回应，语气要温暖，使用清晰简单的语言，适合中老年人理解。请考虑他们的情绪状态来回应。",
            }
        ],
    )
...
async def answer_as(name):
    ...
    stream = await openai_client.chat.completions.create(
        model=model_name,
        messages=message_history + [{"role": "assistant", "content": f"你是一位关心、耐心且善解人意的照护助手，有比较强的医疗数据分析能力，并且具有很强的心理分析能力，很擅长使用温暖，清晰的语言与用户沟通。在对话的过程中需要分析用户说话的情绪状态,并用简体中文回应，语气要温暖，使用清晰简单的语言，适合中老年人理解。speak as {name}"}],
        stream=True,
        **settings,
    )
